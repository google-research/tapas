...
class TableDatasetTest(parameterized.TestCase, tf.test.TestCase):
  ...
  @parameterized.named_parameters(
      ("train_with_aggregation", 10, 10, False, True, False, False, False,
       False),
      ("train_with_weak_supervision", 10, 10, False, True, True, False, False,
       False),
      ("train", 10, 10, False, False, False, False, False, False),
      ("pretrain", 10, 10, True, False, False, False, False, False),
      ("predict", 10, 10, False, False, False, True, False, False),
      ("predict_with_aggregation", 10, 10, False, True, False, True, False,
       False),
      ("predict_with_weak_supervision", 10, 10, False, True, True, True, False,
       False),
      ("train_with_candidate_answers", 10, 10, False, True, True, False, True,
       False),
      ("train_with_classification", 10, 10, False, True, False, False, False,
       True),
      ("predict_with_classification", 10, 10, False, True, False, True, False,
       True),
  )
  def test_parse_table_examples(self, max_seq_length, max_predictions_per_seq,
                                is_pretraining, add_aggregation_function_id,
